...
public class AnswersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ans1 = (RadioButton) rootView.findViewById(R.id.answerOne);
        ans2 = (RadioButton) rootView.findViewById(R.id.answerTwo);
        ans3 = (RadioButton) rootView.findViewById(R.id.answerThree);
        ans4 = (RadioButton) rootView.findViewById(R.id.answerFour);
